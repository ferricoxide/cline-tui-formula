...
*   Created cline-tui directory-tree contents by:
    1.   Cloning https://github.com/saltstack-formulas/template-formula.git
    2.   Executing `bin/convert-formula.sh cline-tui` in the new repo-copy
    3.   Moving the resulting `cline-tui` directory into this project's space
    4.   Updating all imports from "`cline__tui`" to "`claude_tui`"
